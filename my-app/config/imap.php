    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            ...
            // The office mailbox this points at has tens of thousands of
            // messages and no server-side full-text index, so an IMAP BODY
            // search (used by the Quotes "Pull Emails" search — see
            // App\Services\QuoteEmailSearcher) has to scan every message and
            // measured ~60s even for a search matching nothing. The package
            // default of 30s reliably timed out mid-search ("empty
            // response"), so this is padded well above that observed floor.
            "timeout" => 120,
            "extensions" => []
        ],
